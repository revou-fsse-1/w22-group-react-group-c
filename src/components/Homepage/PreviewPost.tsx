...
export default function PreviewPostComponent() {
  return (
    <div className=" mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-11 mt-10 mb-20">
      <div className="mt-20 max-w-sm rounded overflow-hidden shadow-lg">
        <img
          className="w-full"
